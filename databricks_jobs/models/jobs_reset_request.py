...
class JobsResetRequest(BaseModel):
    ...
    __properties = ["job_id", "new_settings"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JobsResetRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JobsResetRequest:
        """Create an instance of JobsResetRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return JobsResetRequest.parse_obj(obj)

        _obj = JobsResetRequest.parse_obj(
            {
