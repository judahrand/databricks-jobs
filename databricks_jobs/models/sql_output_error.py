...
class SqlOutputError(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SqlOutputError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SqlOutputError:
        """Create an instance of SqlOutputError from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SqlOutputError.parse_obj(obj)

        _obj = SqlOutputError.parse_obj({"message": obj.get("message")})
        return _obj
