...
T = TypeVar("T", bound="JobsRunsGetResponse200")


@attr.s(auto_attribs=True)
class JobsRunsGetResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        jobs_runs_get_response_200 = cls(
            job_id=job_id,
            run_id=run_id,
        ...
        jobs_runs_get_response_200.additional_properties = d
        return jobs_runs_get_response_200
