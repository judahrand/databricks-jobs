...
class JobsList200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JobsList200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JobsList200Response:
        """Create an instance of JobsList200Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return JobsList200Response.parse_obj(obj)

        _obj = JobsList200Response.parse_obj(
            {
                "jobs": [Job.from_dict(_item) for _item in obj.get("jobs")]
