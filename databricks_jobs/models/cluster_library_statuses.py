...
class ClusterLibraryStatuses(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClusterLibraryStatuses:
    ...
    def to_dict(self):
        ...
        if self.library_statuses:
            for _item in self.library_statuses:
                if _item:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClusterLibraryStatuses:
        """Create an instance of ClusterLibraryStatuses from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ClusterLibraryStatuses.parse_obj(obj)

        _obj = ClusterLibraryStatuses.parse_obj(
            {
                "cluster_id": obj.get("cluster_id"),
                "library_statuses": [
                    LibraryFullStatus.from_dict(_item)
                    for _item in obj.get("library_statuses")
                ]
                if obj.get("library_statuses") is not None
                else None,
            }
        )
        return _obj
