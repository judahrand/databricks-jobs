...
class TerminationReason(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TerminationReason:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TerminationReason:
        """Create an instance of TerminationReason from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TerminationReason.parse_obj(obj)

        _obj = TerminationReason.parse_obj(
            {
                "code": obj.get("code"),
                "type": obj.get("type"),
