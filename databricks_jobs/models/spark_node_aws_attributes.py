...
class SparkNodeAwsAttributes(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SparkNodeAwsAttributes:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SparkNodeAwsAttributes:
        """Create an instance of SparkNodeAwsAttributes from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SparkNodeAwsAttributes.parse_obj(obj)

        _obj = SparkNodeAwsAttributes.parse_obj({"is_spot": obj.get("is_spot")})
        return _obj
