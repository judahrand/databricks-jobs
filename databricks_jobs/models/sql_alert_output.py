...
class SqlAlertOutput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SqlAlertOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SqlAlertOutput:
        """Create an instance of SqlAlertOutput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SqlAlertOutput.parse_obj(obj)

        _obj = SqlAlertOutput.parse_obj(
            {
