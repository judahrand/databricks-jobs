...
class RunSubmitTaskSettings(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RunSubmitTaskSettings:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RunSubmitTaskSettings:
        """Create an instance of RunSubmitTaskSettings from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return RunSubmitTaskSettings.parse_obj(obj)

        _obj = RunSubmitTaskSettings.parse_obj(
            {
