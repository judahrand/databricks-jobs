...
class EventDetails:
    ...
    Attributes:
        ...
        previous_attributes (Union[Unset, AzureAttributes]):
        attributes (Union[Unset, AzureAttributes]):
        ...
        user (Union[Unset, str]): The user that caused the event to occur. (Empty if it was done by Azure Databricks.)
    """

    current_num_workers: Union[Unset, int] = UNSET
    target_num_workers: Union[Unset, int] = UNSET
    previous_attributes: Union[Unset, "AzureAttributes"] = UNSET
    attributes: Union[Unset, "AzureAttributes"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_previous_attributes, Unset):
            ...
            previous_attributes = AzureAttributes.from_dict(_previous_attributes)
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = AzureAttributes.from_dict(_attributes)
