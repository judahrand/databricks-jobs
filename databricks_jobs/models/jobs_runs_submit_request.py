...
class JobsRunsSubmitRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JobsRunsSubmitRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JobsRunsSubmitRequest:
        """Create an instance of JobsRunsSubmitRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return JobsRunsSubmitRequest.parse_obj(obj)

        _obj = JobsRunsSubmitRequest.parse_obj(
            {
                "tasks": [
