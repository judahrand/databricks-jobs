...
class AccessControlRequestForServicePrincipal(BaseModel):
    ...
    service_principal_name: Optional[StrictStr] = Field(
        None, description="Name of an Azure service principal."
    )
    permission_level: Optional[PermissionLevel] = None
    __properties = ["service_principal_name", "permission_level"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccessControlRequestForServicePrincipal:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccessControlRequestForServicePrincipal:
        """Create an instance of AccessControlRequestForServicePrincipal from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AccessControlRequestForServicePrincipal.parse_obj(obj)
