...
class PythonPyPiLibrary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PythonPyPiLibrary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PythonPyPiLibrary:
        """Create an instance of PythonPyPiLibrary from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PythonPyPiLibrary.parse_obj(obj)

        _obj = PythonPyPiLibrary.parse_obj(
            {"package": obj.get("package"), "repo": obj.get("repo")}
        )
        return _obj
