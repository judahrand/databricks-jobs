...
class DockerBasicAuth(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DockerBasicAuth:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DockerBasicAuth:
        """Create an instance of DockerBasicAuth from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DockerBasicAuth.parse_obj(obj)

        _obj = DockerBasicAuth.parse_obj(
