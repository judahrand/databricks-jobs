...
class MavenLibrary(BaseModel):
    ...
    exclusions: Optional[List[StrictStr]] = Field(
        None,
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MavenLibrary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MavenLibrary:
        """Create an instance of MavenLibrary from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MavenLibrary.parse_obj(obj)

        _obj = MavenLibrary.parse_obj(
            {
