...
T = TypeVar("T", bound="JobsRunsSubmitJsonBody")


@attr.s(auto_attribs=True)
class JobsRunsSubmitJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        jobs_runs_submit_json_body = cls(
            tasks=tasks,
            run_name=run_name,
        ...
        jobs_runs_submit_json_body.additional_properties = d
        return jobs_runs_submit_json_body
