...
class TaskSparkSubmitTask(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskSparkSubmitTask:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskSparkSubmitTask:
        """Create an instance of TaskSparkSubmitTask from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TaskSparkSubmitTask.parse_obj(obj)

        _obj = TaskSparkSubmitTask.parse_obj({"parameters": obj.get("parameters")})
        return _obj
