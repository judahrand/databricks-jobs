...
class DbfsStorageInfo(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DbfsStorageInfo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DbfsStorageInfo:
        """Create an instance of DbfsStorageInfo from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DbfsStorageInfo.parse_obj(obj)

        _obj = DbfsStorageInfo.parse_obj({"destination": obj.get("destination")})
        return _obj
