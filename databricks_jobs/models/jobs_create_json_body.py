...
T = TypeVar("T", bound="JobsCreateJsonBody")


@attr.s(auto_attribs=True)
class JobsCreateJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        jobs_create_json_body.additional_properties = d
        return jobs_create_json_body
