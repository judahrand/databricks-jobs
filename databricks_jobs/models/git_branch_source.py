...
class GitBranchSource(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GitBranchSource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GitBranchSource:
        """Create an instance of GitBranchSource from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GitBranchSource.parse_obj(obj)

        _obj = GitBranchSource.parse_obj(
            {
