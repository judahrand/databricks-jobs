...
class DockerImage(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DockerImage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DockerImage:
        """Create an instance of DockerImage from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DockerImage.parse_obj(obj)

        _obj = DockerImage.parse_obj(
            {
                "url": obj.get("url"),
                "basic_auth": DockerBasicAuth.from_dict(obj.get("basic_auth"))
                if obj.get("basic_auth") is not None
                else None,
            }
        )
        return _obj
