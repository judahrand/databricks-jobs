...
class RunParametersPipelineParams(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RunParametersPipelineParams:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RunParametersPipelineParams:
        """Create an instance of RunParametersPipelineParams from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return RunParametersPipelineParams.parse_obj(obj)
