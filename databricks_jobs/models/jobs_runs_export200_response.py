...
class JobsRunsExport200Response(BaseModel):
    ...
    views: Optional[List[ViewItem]] = Field(
        None,
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JobsRunsExport200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JobsRunsExport200Response:
        """Create an instance of JobsRunsExport200Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return JobsRunsExport200Response.parse_obj(obj)

        _obj = JobsRunsExport200Response.parse_obj(
            {
                "views": [ViewItem.from_dict(_item) for _item in obj.get("views")]
