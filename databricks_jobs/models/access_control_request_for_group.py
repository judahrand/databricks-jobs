...
class AccessControlRequestForGroup(BaseModel):
    ...
    __properties = ["group_name", "permission_level"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccessControlRequestForGroup:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccessControlRequestForGroup:
        """Create an instance of AccessControlRequestForGroup from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AccessControlRequestForGroup.parse_obj(obj)
